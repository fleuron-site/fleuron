...
return [
    ...
    'skill_id' => 'Skill',
    'skill_id__placeholder' => 'Select skill',
    ...
    'index_route_description' => 'Retrieve existing userinfosskills.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the userinfosskill property name where the value is the assigned value to the retrieved userinfosskill.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved userinfosskill.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of userinfosskills per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved userinfosskill.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new userinfosskill.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing userinfosskill.',
    ...
    'show_route_description' => 'Retrieve existsing userinfosskill.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the userinfosskill to retrieve',
    'destroy_route_description' => 'Delete existsing userinfosskill.',
    ...
    'the_id_of_model_to_delete' => 'The id of the userinfosskill to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete userinfosskills.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the userinfosskill.',
    ...
    'the_requested_model_does_not_exists' => 'The requested userinfosskill does not exists.',
    ...
    'create' => 'Create New Userinfosskill',
    'delete' => 'Delete Userinfosskill',
    'edit' => 'Edit Userinfosskill',
    'show' => 'Show Userinfosskill',
    'show_all' => 'Show All Userinfosskill',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Userinfosskill.',
    'none_available' => 'No Userinfosskills Available.',
    'model_plural' => 'Userinfosskills',
    'model_was_added' => 'Userinfosskill was successfully added.',
    'model_was_retrieved' => 'Userinfosskill was successfully retrieved.',
    'models_were_retrieved' => 'Userinfosskills were successfully retrieved.',
    'model_was_updated' => 'Userinfosskill was successfully updated.',
    'model_was_deleted' => 'Userinfosskill was successfully deleted.',
    ...
    'model_id_camel_case' => 'userinfosskillId',
