...
return [
    ...
    'tel' => 'Téléphone',
    'tel__placeholder' => 'Entrez numéro de téléphone ici...',
    'amount_hour' => 'Montant horaire',
    'amount_hour__placeholder' => 'Entrez montant horaire ici...',
    'vacant' => 'Disponibilité',
    'vacant__placeholder' => 'Enter vacant here...',
    'about' => 'About',
    'about__placeholder' => 'Entrez votre biographie ici...',
    'created_at' => 'Créé au',
    'created_at__placeholder' => 'Enter created at here...',
    'updated_at' => 'Updated At',
    'updated_at__placeholder' => 'Enter updated at here...',
    'countrie_id' => 'Pays',
    'countrie_id__placeholder' => 'Entrez votre pays ici...',
    'users_id' => 'Utilisateur',
    'users_id__placeholder' => 'Selectionnez l\'Utilisateur',
    'access_token_with_bearer' => 'The access token prefixed with the "Bearer " key word.',
    'index_route_description' => 'Retrieve existing userinfos.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the userinfo property name where the value is the assigned value to the retrieved userinfo.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved userinfo.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of userinfos per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved userinfo.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new userinfo.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing userinfo.',
    ...
    'show_route_description' => 'Retrieve existsing userinfo.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the userinfo to retrieve',
    'destroy_route_description' => 'Delete existsing userinfo.',
    ...
    'the_id_of_model_to_delete' => 'The id of the userinfo to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete userinfos.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the userinfo.',
    ...
    'the_requested_model_does_not_exists' => 'The requested userinfo does not exists.',
    ...
    'create' => 'Create New Userinfo',
    'delete' => 'Delete Userinfo',
    'edit' => 'Edit Userinfo',
    'show' => 'Show Userinfo',
    'show_all' => 'Show All Userinfo',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Userinfo.',
    'none_available' => 'No Userinfos Available.',
    'model_plural' => 'Userinfos',
    'model_was_added' => 'Userinfo was successfully added.',
    'model_was_retrieved' => 'Userinfo was successfully retrieved.',
    'models_were_retrieved' => 'Userinfos were successfully retrieved.',
    'model_was_updated' => 'Userinfo was successfully updated.',
    'model_was_deleted' => 'Userinfo was successfully deleted.',
    ...
    'model_id_camel_case' => 'userinfoId',
    ...
    'vacant_disponible' => 'Disponible',
    'vacant_indisponible' => 'Indisponible',
    'vacant_oui' => 'Oui',
    'vacant_non' => 'Non',
