...
return [
    ...
    'userinfo_id' => 'Information utilisateur',
    'userinfo_id__placeholder' => 'Selectionnez informations concernant utilisateur',
    'skill_id' => 'Compétances',
    'skill_id__placeholder' => 'Selectionnez vos compétances',
    'access_token_with_bearer' => 'The access token prefixed with the "Bearer " key word.',
    'index_route_description' => 'Retrieve existing userinfos skills.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the userinfos skills property name where the value is the assigned value to the retrieved userinfos skills.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved userinfos skills.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of userinfos skills per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved userinfos skills.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new userinfos skills.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing userinfos skills.',
    ...
    'show_route_description' => 'Retrieve existsing userinfos skills.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the userinfos skills to retrieve',
    'destroy_route_description' => 'Delete existsing userinfos skills.',
    ...
    'the_id_of_model_to_delete' => 'The id of the userinfos skills to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete userinfos skills.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the userinfos skills.',
    ...
    'the_requested_model_does_not_exists' => 'The requested userinfos skills does not exists.',
    ...
    'create' => 'Create New Userinfos Skill',
    'delete' => 'Delete Userinfos Skill',
    'edit' => 'Edit Userinfos Skill',
    'show' => 'Show Userinfos Skill',
    'show_all' => 'Show All Userinfos Skill',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Userinfos Skill.',
    'none_available' => 'No Userinfos Skills Available.',
    'model_plural' => 'Userinfos Skills',
    'model_was_added' => 'Userinfos Skill was successfully added.',
    'model_was_retrieved' => 'Userinfos Skill was successfully retrieved.',
    'models_were_retrieved' => 'Userinfos Skills were successfully retrieved.',
    'model_was_updated' => 'Userinfos Skill was successfully updated.',
    'model_was_deleted' => 'Userinfos Skill was successfully deleted.',
    ...
    'model_id_camel_case' => 'userinfos skillId',
