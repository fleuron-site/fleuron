            ...
            <div class="default">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('admin.countries.countrie.update', $country->id) }}" id="edit_country_form" name="edit_country_form" accept-charset="UTF-8" class="form-horizontal">
                        {{ csrf_field() }}
