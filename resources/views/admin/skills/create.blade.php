            ...
            <div class="default">
                <div class="card card-header-actions p-4">
                    <div class="card-body px-0">
                        ...
                        <form method="POST" action="{{ route('admin.skills.skill.store') }}" accept-charset="UTF-8" id="create_skill_form" name="create_skill_form" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
